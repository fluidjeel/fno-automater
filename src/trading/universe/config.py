...
from trading.domain.contracts.base import ExactDecimal, NonEmptyStr, StrictInt, StrictModel
...
class UniverseScannerConfig(StrictModel):
    ...
    min_entry_conviction_regime_aligned: ConvictionLevel = Field(default=ConvictionLevel.MODERATE)
    min_entry_conviction_regime_opposed: ConvictionLevel = Field(default=ConvictionLevel.STRONG)
