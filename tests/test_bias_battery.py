...
def _cohort() -> tuple[TradeOutcomeInput, ...]:
    return (
        _trade(0, winner=True, hold="120", capture="0.60", pnl="1.0", cost="0.10", conf="0.70", verdict="0.70", size="1.0"),
        _trade(1, winner=False, hold="40", capture="0.00", pnl="-0.8", cost="0.10", conf="0.60", verdict="0.40", size="1.0"),
        _trade(2, winner=True, hold="180", capture="0.50", pnl="1.2", cost="0.15", conf="0.80", verdict="0.75", size="1.1"),
        _trade(3, winner=False, hold="30", capture="0.00", pnl="-0.5", cost="0.08", conf="0.55", verdict="0.30", size="0.9", weekday=2, hour=14),
        _trade(4, winner=True, hold="90", capture="0.70", pnl="0.9", cost="0.12", conf="0.65", verdict="0.60", size="1.2"),
        _trade(5, winner=True, hold="100", capture="0.55", pnl="1.1", cost="0.10", conf="0.70", verdict="0.65", size="1.3"),
        _trade(6, winner=True, hold="110", capture="0.50", pnl="1.0", cost="0.10", conf="0.75", verdict="0.70", size="1.4"),
    )
